<div class="sales-panel">
	...
	<div class="tab-content">
		<!-- New sale -->
		<div class="tab-pane fade card card-forms" id="newSale" role="tabpanel">
		...
		<!-- Sales history -->
		<div class="tab-pane fade show active card" id="salesHistory" role="tabpanel">
            <div class="card-head">
        ...
        <div class="tab-pane fade card" id="refunds" role="tabpanel">
        	<div class="card-head">
                <h5 class="mb-3">Historial de devoluciones</h5>
            </div>
            <form method="POST" class="d-flex flex-column">
                <div class="form-group mb-3">
                    <label for="pcodeInput" class="form-label">Intervalo de tiempo</label>
