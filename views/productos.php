<div class="products-panel">
	...
	<ul class="nav nav-tabs flex-colum justify-content-around" role="tablist">
		<li class="nav-item" role="presentation">
			<a href="#addProduct" class="nav-link active" data-bs-toggle="tab" data-bs-target="#addProduct" type="button" role="tab" aria-selected="true"><i class="fas fa-box"></i> Añadir producto</a>
		</li>
		<li class="nav-item" role="presentation">
	...
	<div class="tab-content">
        <!-- Add product -->
		<div class="tab-pane fade show active card card-forms" id="addProduct" role="tabpanel">
